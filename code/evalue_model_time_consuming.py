...
def main():
    ...
    for filename in os.listdir(folder_selected):
        if filename.endswith('.txt'):
            ...
            if input_data.size > 0:
                ...
                data_counts += input_data.shape[0]
    ...
    Elapsed_time_total = np.array(Elapsed_time_total)
    print("Processing completed")
    print(f"Total samples: {data_counts}, Average time: {Elapsed_time_total.sum() / data_counts}")
